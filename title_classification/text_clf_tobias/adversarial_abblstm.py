...
if __name__ == '__main__':
    ...
    # data preprocessing
    x_train, x_dev, vocab_freq, word2idx, vocab_size = \
        data_preprocessing_with_dict(x_train, x_dev, max_len=16)
    ...
    os.makedirs(f"{BIG_CATEGORY}/adv_abblstm", exist_ok=True)
    ...
    for e in range(config["train_epoch"]):
        ...
        if dev_acc > max_acc:
            max_acc = dev_acc
            saver.save(
                sess, f"{BIG_CATEGORY}/adv_abblstm/{dev_acc}.ckpt", global_step=e)
