...
for category in categories:
    ...
    os.makedirs(str(prob_dir / category / 'bert_v1'), exist_ok=True)
    np.save(str(prob_dir / category / 'bert_v1' / 'valid.npy'), val_prob)
    np.save(str(prob_dir / category / 'bert_v1' / 'test.npy'), test_prob)
