...
if __name__ == '__main__':
    ...
    param_dict = {'min_child_weight': 3, 'gamma': 0.00043042962756640143, 'colsample_bylevel': 0.872677186090371, 'scale_pos_weight': 28.589594129413953, 'n_estimators': 7, 'n_jobs': -1, 'objective': 'multi:softmax',
