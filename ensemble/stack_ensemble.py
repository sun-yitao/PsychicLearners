...
def two_head_ensemble_model(dense1=None, dense2=None, dropout=0.25, k_reg=0):
    k_regularizer = keras.regularizers.l2(k_reg)
...
def predict_all():
    beauty_preds = predict(
        '/Users/sunyitao/Documents/Projects/GitHub/PsychicLearners/data/keras_checkpoints/beauty/combined/8+adv+atten_bilstm_checkpoints/model.10-0.80.h5',
        big_category='beauty')
    ...
    fashion_preds = predict(
        '/Users/sunyitao/Documents/Projects/GitHub/PsychicLearners/data/keras_checkpoints/fashion/combined/8+adv+atten_bilstm_checkpoints/model.17-0.68.h5',
    ...
    mobile_preds = predict(
        '/Users/sunyitao/Documents/Projects/GitHub/PsychicLearners/data/keras_checkpoints/mobile/combined/8+adv+atten_bilstm_checkpoints/model.24-0.85.h5',
        big_category='mobile')
