...
TRAIN_DIR = os.path.join('..', 'data', 'image', 'v1_train_240x240', 'fashion')
VAL_DIR = os.path.join('..', 'data', 'image', 'valid_240x240', 'fashion')
CHECKPOINT_PATH = os.path.join('..', 'data', 'keras_checkpoints', 'fashion')
