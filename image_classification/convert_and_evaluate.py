...
TRAIN_DIR = os.path.join(psychic_learners_dir, 'data', 'image', 'v1_train_nodups_240x240', 'beauty')
VAL_DIR = os.path.join(psychic_learners_dir, 'data', 'image', 'valid_240x240', 'beauty')
CHECKPOINT_PATH = os.path.join(psychic_learners_dir, 'data', 'keras_checkpoints', 'beauty', 'converted_model.h5')
